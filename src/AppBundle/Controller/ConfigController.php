...
class ConfigController extends Controller
{
     ...
     *
     * @Route("/new", name="crud_config_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('crud_config_show', array('id' => $config->getId()));
        }
     ...
     *
     * @Route("/{id}", name="crud_config_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}/edit", name="crud_config_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Config $config)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('crud_config_edit', array('id' => $config->getId()));
        }
     ...
     *
     * @Route("/{id}", name="crud_config_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Config $config)
    {
        ...
        return $this->redirectToRoute('crud_config_index');
    }
    ...
    private function createDeleteForm(Config $config)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('crud_config_delete', array('id' => $config->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
